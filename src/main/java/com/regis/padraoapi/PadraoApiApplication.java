...
public class PadraoApiApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Prod e1 = new Prod(null, 158641, "REQUEIJAO TIROL TRADICIONAL 180 G", "7896294900712", marc1);
		Prod e2 = new Prod(null, 95522, "AZEITE ANDORINHA EXT VIRGEM VD 500 ML", "5601216120152", marc1);

		marc1.getProd().addAll(Arrays.asList(e1, e2));

		marcRepository.saveAll(Arrays.asList(marc1));
		prodRepository.saveAll(Arrays.asList(e1, e2));
